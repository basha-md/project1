...
public class TestCase5 extends ListenerClass
{
	@Test
	public void login_to_Search()
	{
		...
		a3.viewyourlist();
		a3.addtocart();
		a3.proceedtocheckout();	
		
		Amazon_AddressPage5 a4 = new Amazon_AddressPage5(driver);
		a4.selectaddress();
		a4.usethisaddress();
		
		Assert.assertEquals(driver.getTitle(), "Select a delivery address", "testcase05-fail");
	}
}
